...
import { isVisionDecompositionResult, isVisionStrategyResult } from "../../../src/shared/domain/vision";
export { isVisionDecompositionResult, isVisionStrategyResult } from "../../../src/shared/domain/vision";
...
export type VisionStrategyGenerator = (input: VisionStrategyRequest | VisionDecompositionRequest) => Promise<unknown>;
...
export function createVisionStrategyRoute(generate: VisionStrategyGenerator) {
  return async (req: Request, res: Response) => {
    ...
    const mode = req.body?.mode === "decompose" ? "decompose" : "strategy";
