...
export type AddVisionCandidateResult = { draft: DailyPlanDraft } | { error: "duplicate" | "capacity_exceeded" | "invalid_plan" };
...
export function addVisionCandidateToPlan(draft: DailyPlanDraft, candidate: TodayCandidate): AddVisionCandidateResult {
  ...
  const block = exceedsExplicitCapacity || draft.availableMinutes === undefined ? "if_capacity_remains" as const : "later_today" as const;
