import { Check, ChevronDown, Leaf, Minus, SkipForward, Settings2 } from "lucide-react";
  ...
  return (
    <section className="mx-auto mt-7 w-full max-w-[760px] px-5 pb-2 sm:px-6" aria-labelledby="daily-routines-heading">
      <div className="mb-3 flex items-start justify-between">
        ...
        <button onClick={() => setIsManaging(true)} className="p-2 hover:bg-black/5 rounded-full dark:text-white dark:hover:bg-white/10">
          ...
          return (
            <article key={routine.id} className="p-4 sm:p-5">
              <div className="flex items-start gap-3">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[11px] bg-[#34C759]/10 text-[#34C759] dark:bg-[#30D158]/15 dark:text-[#30D158]"><Leaf className="h-5 w-5" aria-hidden="true" /></span>
