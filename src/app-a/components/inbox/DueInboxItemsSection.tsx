...
const COPY = {
  en: { title: "Scheduled for today", intro: "Inbox items whose scheduled date has arrived.", add: "Add to plan", estimate: "about 20 min", error: "Scheduled Inbox items could not be loaded.", noPlan: "Create today's plan before adding this item.", duration_required: "A neutral 20-minute estimate will be used.", duplicate: "This item is already in today's plan.", capacity_unknown: "This item could not be added safely.", capacity_exceeded: "This item does not fit in today's remaining time.", invalid_plan: "This item could not be added safely." },
  sr: { title: "Zakazano za danas", intro: "Stavke iz Inboksa čiji je zakazani datum stigao.", add: "Dodaj u plan", estimate: "oko 20 min", error: "Zakazane stavke iz Inboksa nisu učitane.", noPlan: "Prvo napravite današnji plan.", duration_required: "Biće korišćena neutralna procena od 20 minuta.", duplicate: "Ova stavka je već u današnjem planu.", capacity_unknown: "Stavka nije mogla bezbedno da se doda.", capacity_exceeded: "Ova stavka ne staje u preostalo vreme.", invalid_plan: "Stavka nije mogla bezbedno da se doda." },
  tr: { title: "Bugün için planlananlar", intro: "Planlanan tarihi gelen Gelen Kutusu öğeleri.", add: "Plana ekle", estimate: "yaklaşık 20 dk", error: "Planlanan Gelen Kutusu öğeleri yüklenemedi.", noPlan: "Bu öğeyi eklemeden önce bugünün planını oluşturun.", duration_required: "20 dakikalık tarafsız bir tahmin kullanılacak.", duplicate: "Bu öğe zaten bugünün planında.", capacity_unknown: "Bu öğe güvenli biçimde eklenemedi.", capacity_exceeded: "Bu öğe bugünkü kalan süreye sığmıyor.", invalid_plan: "Bu öğe güvenli biçimde eklenemedi." },
} as const;
