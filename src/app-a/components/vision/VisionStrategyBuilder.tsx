...
const COPY = {
  en: { develop: "Develop this direction", loading: "Turning the idea into a practical path…", error: "The direction could not be developed. Try again.", saveError: "The strategy could not be saved.", saved: "Saved", imagine: "Imagine", plan: "Plan", check: "Check", why: "Why it matters", risks: "Risks", assumptions: "Assumptions to verify", next: "Smallest useful next step", hide: "Hide strategy", show: "Show strategy", breakDown: "Break down only if needed", checking: "Checking usefulness…", concrete: "This step is already concrete enough.", send: "Send to Today", confirmTitle: "Send this candidate to Today?", confirmHelp: "It will appear as an unscheduled candidate and will not change your confirmed plan.", duration: "Estimated minutes", cancel: "Cancel", confirm: "Send candidate", sent: "Sent to Today" },
  sr: { develop: "Razradi ovaj pravac", loading: "Pretvaram ideju u praktičan put…", error: "Pravac nije mogao da se razradi. Pokušajte ponovo.", saveError: "Strategija nije mogla da se sačuva.", saved: "Sačuvano", imagine: "Zamisli", plan: "Isplaniraj", check: "Proveri", why: "Zašto je važno", risks: "Rizici", assumptions: "Pretpostavke koje treba proveriti", next: "Najmanji koristan sledeći korak", hide: "Sakrij strategiju", show: "Prikaži strategiju", breakDown: "Razloži samo ako je potrebno", checking: "Proveravam korisnost…", concrete: "Ovaj korak je već dovoljno konkretan.", send: "Pošalji u Danas", confirmTitle: "Poslati ovaj kandidat u Danas?", confirmHelp: "Pojaviće se kao neraspoređen kandidat i neće promeniti potvrđeni plan.", duration: "Procenjeno minuta", cancel: "Otkaži", confirm: "Pošalji kandidata", sent: "Poslato u Danas" },
