...
const COPY = {
  en: { title: "From your Vision", intro: "Unscheduled candidates you explicitly sent here. Adding one checks the confirmed plan's remaining capacity.", add: "Add to plan", dismiss: "Dismiss candidate", error: "Vision candidates could not be loaded.", duplicate: "This step is already in the plan.", capacity_unknown: "Set available time before adding this candidate.", capacity_exceeded: "This candidate does not fit in the remaining required-plan capacity.", invalid_plan: "This candidate could not be added safely." },
  sr: { title: "Iz vaše Vizije", intro: "Neraspoređeni kandidati koje ste izričito poslali ovde. Dodavanje proverava preostali kapacitet potvrđenog plana.", add: "Dodaj u plan", dismiss: "Ukloni kandidata", error: "Kandidati iz Vizije nisu učitani.", duplicate: "Ovaj korak je već u planu.", capacity_unknown: "Postavite raspoloživo vreme pre dodavanja kandidata.", capacity_exceeded: "Kandidat ne staje u preostali kapacitet obaveznog plana.", invalid_plan: "Kandidat nije mogao bezbedno da se doda." },
  tr: { title: "Vizyonunuzdan", intro: "Buraya açıkça gönderdiğiniz plansız adaylar. Ekleme, onaylı planın kalan kapasitesini kontrol eder.", add: "Plana ekle", dismiss: "Adayı kaldır", error: "Vizyon adayları yüklenemedi.", duplicate: "Bu adım zaten planda.", capacity_unknown: "Bu adayı eklemeden önce kullanılabilir süreyi ayarlayın.", capacity_exceeded: "Bu aday zorunlu planın kalan kapasitesine sığmıyor.", invalid_plan: "Bu aday güvenli şekilde eklenemedi." },
} as const;
