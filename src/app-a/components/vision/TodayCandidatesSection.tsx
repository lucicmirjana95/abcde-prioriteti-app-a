...
const COPY = {
  en: { title: "Next steps from your Vision", intro: "Steps you explicitly sent here. Adding one checks the confirmed plan's remaining capacity.", add: "Add to plan", dismiss: "Remove step", error: "Vision steps could not be loaded.", duplicate: "This step is already in the plan.", capacity_unknown: "Set available time before adding this step.", capacity_exceeded: "This step does not fit in the remaining required-plan capacity.", invalid_plan: "This step could not be added safely." },
  sr: { title: "Sledeći koraci iz vaše Vizije", intro: "Koraci koje ste izričito poslali ovde. Dodavanje proverava preostali kapacitet potvrđenog plana.", add: "Dodaj u plan", dismiss: "Ukloni korak", error: "Koraci iz Vizije nisu učitani.", duplicate: "Ovaj korak je već u planu.", capacity_unknown: "Postavite raspoloživo vreme pre dodavanja ovog koraka.", capacity_exceeded: "Ovaj korak ne staje u preostali kapacitet obaveznog plana.", invalid_plan: "Ovaj korak nije mogao bezbedno da se doda." },
  tr: { title: "Vizyonunuzdan sonraki adımlar", intro: "Buraya açıkça gönderdiğiniz adımlar. Ekleme, onaylı planın kalan kapasitesini kontrol eder.", add: "Plana ekle", dismiss: "Adımı kaldır", error: "Vizyon adımları yüklenemedi.", duplicate: "Bu adım zaten planda.", capacity_unknown: "Bu adımı eklemeden önce kullanılabilir süreyi ayarlayın.", capacity_exceeded: "Bu adım zorunlu planın kalan kapasitesine sığmıyor.", invalid_plan: "Bu adım güvenli şekilde eklenemedi." },
} as const;
