...
> = {
  en: {
    common: {
      ...
      restSoundEnabled: "Ambient sound enabled",
      restSoundDisabled: "Ambient sound disabled",
      restSoundPlaying: "Ambient soundscape is playing. Best with headphones.",
  ...
  sr: {
    common: {
      ...
      restSoundEnabled: "Ambijentalni zvuk uključen",
      restSoundDisabled: "Ambijentalni zvuk isključen",
      restSoundPlaying: "Ambijentalni zvuk se reprodukuje. Najbolje uz slušalice.",
  ...
  tr: {
    common: {
      ...
      restSoundEnabled: "Ortam sesi açık",
      restSoundDisabled: "Ortam sesi kapalı",
      restSoundPlaying: "Ortam sesi çalıyor. Kulaklıkla dinlenmesi önerilir.",
